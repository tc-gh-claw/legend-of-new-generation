        ...
        const questionBank = {
            'math': {
                1: [
                    ...
                    { question: '10 × 10 = ?', options: ['100', '20', '1000', '50'], correct: 0 },
                    { question: '36 ÷ 6 = ?', options: ['5', '6', '7', '8'], correct: 1 },
                    { question: '一個正方形有幾條邊？', options: ['3', '4', '5', '6'], correct: 1 },
                    { question: '15 - 9 = ?', options: ['5', '6', '7', '8'], correct: 1 }
                ],
                2: [
                    ...
                    { question: '1/4 + 1/2 = ?', options: ['1/6', '3/4', '2/6', '1'], correct: 1 },
                    { question: '0.75 等於幾分之幾？', options: ['1/4', '2/3', '3/4', '1/2'], correct: 2 },
                    { question: '如果 3x = 27，那麼 x = ?', options: ['7', '8', '9', '10'], correct: 2 }
                ],
                3: [
                    ...
                    { question: '如果 x + 2y = 10 且 x - y = 1，那麼 x = ?', options: ['3', '4', '5', '6'], correct: 1 },
                    { question: '2⁵ = ?', options: ['16', '25', '32', '64'], correct: 2 },
                    { question: 'cos(60°) = ?', options: ['0', '1/2', '√3/2', '1'], correct: 1 }
                ]
            },
            'science': {
                1: [
                    ...
                    { question: '動物呼吸需要什麼氣體？', options: ['二氧化碳', '氧氣', '氮氣', '氫氣'], correct: 1 },
                    { question: '冰融化成水是什麼變化？', options: ['化學變化', '物理變化', '核變化', '電變化'], correct: 1 },
                    { question: '地球圍繞什麼星球轉？', options: ['火星', '太陽', '月球', '金星'], correct: 1 },
                    { question: '食物在什麼器官被消化？', options: ['心臟', '胃', '肺', '腦'], correct: 1 },
                    { question: '彩虹有幾種顏色？', options: ['5', '6', '7', '8'], correct: 2 }
                ],
                2: [
                    ...
                    { question: '血液循環系統由什麼推動？', options: ['肺', '心臟', '肝臟', '腎臟'], correct: 1 },
                    { question: '聲音在什麼介質傳播最快？', options: ['空氣', '水', '固體', '真空'], correct: 2 },
                    { question: '臭氧層位於大氣層的哪一層？', options: ['對流層', '平流層', '中間層', '熱層'], correct: 1 }
                ],
                3: [
                    ...
                    { question: '宇宙大爆炸發生在約多少年前？', options: ['4.6億年', '46億年', '138億年', '460億年'], correct: 2 },
                    { question: '中子的電荷是？', options: ['+1', '-1', '0', '+2'], correct: 2 },
                    { question: '哪種元素是核反應堆常用的燃料？', options: ['碳', '鈾', '鐵', '鋁'], correct: 1 }
                ]
            },
            'english': {
                1: [
                    ...
                    { question: '"Cat" 的中文是？', options: ['狗', '貓', '鳥', '魚'], correct: 1 },
                    { question: '"Red" 是什麼顏色？', options: ['紅色', '藍色', '綠色', '黃色'], correct: 0 },
                    { question: '"One, Two, _____" 下個數字是？', options: ['Four', 'Three', 'Five', 'Six'], correct: 1 },
                    { question: '"Happy" 的中文意思是？', options: ['傷心的', '生氣的', '開心的', '累的'], correct: 2 },
                    { question: '"Thank you" 的中文是？', options: ['對不起', '謝謝', '你好', '再見'], correct: 1 }
                ],
                2: [
                    ...
                    { question: '"Cat" 的複數是？', options: ['Cats', 'Cates', 'Caties', 'Catses'], correct: 0 },
                    { question: '"She ______ to school every day."', options: ['go', 'goes', 'going', 'gone'], correct: 1 },
                    { question: '"I have been waiting ______ two hours."', options: ['for', 'since', 'at', 'from'], correct: 0 }
                ],
                3: [
                    ...
                    { question: '"Metaphor" 的中文是？', options: ['明喻', '暗喻', '擬人', '誇張'], correct: 1 },
                    { question: '"She runs as fast as a cheetah." 是什麼修辭手法？', options: ['暗喻', '明喻', '擬人', '誇張'], correct: 1 },
                    { question: '"Nevertheless" 的同義詞是？', options: ['Therefore', 'However', 'Moreover', 'Furthermore'], correct: 1 }
                ]
            },
            'general': {
                1: [
                    ...
                    { question: '中國國旗上有幾顆星？', options: ['4', '5', '6', '7'], correct: 1 },
                    { question: '下列哪個是水果？', options: ['胡蘿蔔', '香蕉', '白菜', '土豆'], correct: 1 },
                    { question: '星期一之後是星期幾？', options: ['星期三', '星期二', '星期四', '星期五'], correct: 1 },
                    { question: '太陽從哪個方向升起？', options: ['東方', '西方', '南方', '北方'], correct: 0 },
                    { question: '電話緊急求助號碼是？', options: ['999', '111', '777', '888'], correct: 0 }
                ],
                2: [
                    ...
                    { question: '長城主要位於哪個國家？', options: ['日本', '韓國', '中國', '越南'], correct: 2 },
                    { question: '首屆現代奧運會在哪年舉辦？', options: ['1886', '1896', '1906', '1916'], correct: 1 },
                    { question: '世界上面積最大的洲是？', options: ['非洲', '亞洲', '北美洲', '南極洲'], correct: 1 }
                ],
                3: [
                    ...
                    { question: '美國獨立宣言簽署於哪年？', options: ['1774', '1776', '1786', '1796'], correct: 1 },
                    { question: '冷戰時期的兩大陣營領導國是？', options: ['美國和英國', '美國和蘇聯', '中國和蘇聯', '英國和法國'], correct: 1 },
                    { question: '亞歷山大大帝是哪個國家的統治者？', options: ['羅馬', '希臘', '埃及', '波斯'], correct: 1 }
                ]
            }
        };
